...
export const BACKEND_LEAVE_STATUSES = {
  PENDING: "PENDING",
...
export const BACKEND_TO_FRONTEND_STATUS = {
  [BACKEND_LEAVE_STATUSES.PENDING]: LEAVE_STATUSES.PENDING,
  [BACKEND_LEAVE_STATUSES.PENDING_REVIEW]: LEAVE_STATUSES.PENDING,
  [BACKEND_LEAVE_STATUSES.CLARIFICATION_REQUIRED]: LEAVE_STATUSES.CLARIFICATION,
  [BACKEND_LEAVE_STATUSES.PENDING_DIRECTOR]: LEAVE_STATUSES.ESCALATED,
  [BACKEND_LEAVE_STATUSES.APPROVED]: LEAVE_STATUSES.APPROVED,
  [BACKEND_LEAVE_STATUSES.REJECTED]: LEAVE_STATUSES.REJECTED,
  [BACKEND_LEAVE_STATUSES.WITHDRAWN]: LEAVE_STATUSES.CANCELLED,
};
